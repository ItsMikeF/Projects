...
contests_qb <- lapply(contest_files, function(x){
  ...
  blitz <- function(week) {
    defense_summary <- read.csv(glue("./01_data/contests/2023_w{sprintf(\"%02d\", game_week)}/pff/defense_summary.csv"))
    pass_rush_summary <- read.csv(glue("./01_data/contests/2023_w{sprintf(\"%02d\", game_week)}/pff/pass_rush_summary.csv")) 
    run_defense_summary <- read.csv(glue("./01_data/contests/2023_w{sprintf(\"%02d\", game_week)}/pff/run_defense_summary.csv")) 
    defense_coverage_summary <- read.csv(glue("./01_data/contests/2023_w{sprintf(\"%02d\", game_week)}/pff/defense_coverage_summary.csv"))
    defense_coverage_scheme <- read.csv(glue("./01_data/contests/2023_w{sprintf(\"%02d\", game_week)}/pff/defense_coverage_scheme.csv"))
    slot_coverage <- read.csv(glue("./01_data/contests/2023_w{sprintf(\"%02d\", game_week)}/pff/slot_coverage.csv"))
    pass_rush_productivity <- read.csv(glue("./01_data/contests/2023_w{sprintf(\"%02d\", game_week)}/pff/pass_rush_productivity.csv"))
