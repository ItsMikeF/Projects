...
game_week_schedule <- schedule %>% filter(week == contest_week)
...
running_back <- function(game_year, game_week){
  
 
  
}
running_back(nfl_year, contest_week)
...
load("./04_models/rb_pts_models_v2.Rdata")

#projections
model_projections <- predict(rb_pts_models_v2[[6]], 
                             newdata = rb)
model_projections
