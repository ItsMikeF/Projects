...
nfl_pff_wr <- read.csv("./contests/2022_w2/pff/receiving_summary.csv")
nfl_pff_wr <- replace(nfl_pff_wr, nfl_pff_wr =='D.K. Metcalf','DK Metcalf')

nfl_pff_receiving_scheme <- read.csv("./contests/2022_w2/pff/receiving_scheme.csv")
...
nfl_pff_chart_wr_cb_matchup <- read.csv("./contests/2022_w2/pff/wr_cb_matchup_chart.csv") %>% 
...
nfl_pff_rb <- read.csv("./contests/2022_w2/pff/rushing_summary.csv")

# 1.7 load te data --------------------------------------------------------

nfl_pff_chart_te_matchup <- read.csv("./contests/2022_w2/pff/te_matchup_chart.csv")

# 1.8 load ol data --------------------------------------------------------

nfl_pff_pblk <- read.csv("./contests/2022_w2/pff/line_pass_blocking_efficiency.csv")
...
nfl_pff_chart_oline_dline_matchup <- read.csv("./contests/2022_w2/pff/oline_dline_matchup_chart.csv")
