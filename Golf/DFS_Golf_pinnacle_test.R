...
odds_pn_open <- read.csv(list.files(pattern = "_open.csv"), header = T)
odds_pn_close <- read.csv(list.files(pattern = "_close.csv"), header = T)
...
dg_pred <- read.csv(list.files(pattern = "_preds_ch_model"))
